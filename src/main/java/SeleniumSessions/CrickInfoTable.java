...
public class CrickInfoTable {
	...
	//	System.out.println(driver.findElement(By.xpath("//span[text()='Will Jacks']/ancestor::td/following-sibling::td//span/span")).getText());
		...
		List<String> willJKScoreList = getScoreCareList("Will Jacks");
	...
	public static List<String> getScoreCareList(String playerName) {
